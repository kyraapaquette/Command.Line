...
bandit7@bandit.labs.overthewire.org's password:(use access code from Level 6)
...
^C
bandit7@bandit:~$ grep -a 'millionth'
^C
bandit7@bandit:~$ sort -data.txt 'millionth'
...
bandit7@bandit:~$ grep -i 'millionth'
^C
bandit7@bandit:~$ search 'millionth'
Command 'search' not found, did you mean:
  command 'fsearch' from snap fsearch (0.1.4)
  command 'setarch' from deb util-linux (2.39.3-9ubuntu6.3)
...
millionth       (access code for Level 8)
